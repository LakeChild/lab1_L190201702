...
public class WordGraph
{
    public static void main(String[] args)
    {
        ...
        //分析单词并生成有向图
        Map<String, Map<String, Integer>> graph = showDirectedGraph(text);
    ...
    // 分析文本并生成有向图
    //showDirectedGraph
    private static Map<String, Map<String, Integer>> showDirectedGraph(String text)
    {
...
// 使用Graphviz将DOT文件转换为PNG文件
    ...
    //查找bridge words的
    //queryBridgeWords
    private static void queryBridgeWords(Map<String, Map<String, Integer>> graph, String word1, String word2)
    {
    ...
    // 在图中进行随机搜索的函数
    //randomWalk()
    private static void randomWalk(Map<String, Map<String, Integer>> graph)
    {
